...
`main.tsp` and `authored.schema.json` are independently maintained peer authorities for this API server's parity-gate fixture. Neither file is generated from, ranked below, or allowed to overwrite the other.
